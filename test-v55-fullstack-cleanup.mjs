...
assert.ok(normal.ref); assert.match(normal.ref[1],/SCENE SUMMARY LOCATORS/); assert.match(normal.ref[1],/公开长期摘要/); assert.ok(normal.cur); assert.match(normal.cur[1],/测试大厅/); assert.equal(normal.summary?.[1],''); assert.equal(normal.summary?.[3],0);
