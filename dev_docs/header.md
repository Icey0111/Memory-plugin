...
<!-- VERSION 4 -->
## v4 - 2026-09-12 20:32:10 - register that the retrieval note now carries its own measurement
...
| `04_roadmap.md`     | What shipped, what is next, open risks, what is not planned |
| `05_worktree.md`    | The canonical directory tree and each part’s role |
| `06_retrieval_research.md` | What pairs with entropy in hybrid retrieval, the measured A/B of its first and third layers, and what is left (research note plus measurement) |
| `decisions/`        | ADRs: one durable decision each, with its alternatives and consequences |
...
<!-- VERSION 5 -->
## v5 - 2026-09-12 21:05:40 - register the budget frontier the retrieval note now carries
...
| `04_roadmap.md`     | What shipped, what is next, open risks, what is not planned |
| `05_worktree.md`    | The canonical directory tree and each part’s role |
| `06_retrieval_research.md` | What pairs with entropy in hybrid retrieval; the measured A/B of its first and third layers, the evidence budget frontier, and what is left (research note plus measurement) |
| `decisions/`        | ADRs: one durable decision each, with its alternatives and consequences |
...
<!-- VERSION 6 -->
## v6 - 2026-09-12 21:18:58 - register the dense A/B the retrieval note now carries
...
| `04_roadmap.md`     | What shipped, what is next, open risks, what is not planned |
| `05_worktree.md`    | The canonical directory tree and each part’s role |
| `06_retrieval_research.md` | What pairs with entropy in hybrid retrieval; the measured A/B of its first and third layers, the budget frontier, the dense fusion weight, and what is left (research note plus measurement) |
| `decisions/`        | ADRs: one durable decision each, with its alternatives and consequences |
...
<!-- VERSION 7 -->
## v7 - 2026-09-12 21:51:03 - register the completed layer measurements the retrieval note now carries
...
| `04_roadmap.md`     | What shipped, what is next, open risks, what is not planned |
| `05_worktree.md`    | The canonical directory tree and each part’s role |
| `06_retrieval_research.md` | What pairs with entropy in hybrid retrieval, and all five proposed layers measured to a decision: three shipped, two rejected (research note plus measurement) |
| `decisions/`        | ADRs: one durable decision each, with its alternatives and consequences |
