...
<!-- VERSION 2 -->
## v2 - 2026-09-12 20:32:10 - record what the first and third layers measured, and the three faults that looked like the method losing


**Status: layers 1 and 3 are built and measured; layers 2, 4 and 5 are not started. No ADR: neither layer won its A/B.** - an ADR is
written when a layer wins its A/B (section 6). This file exists so the next session starts from the
conclusion instead of re-reading the discussion.
...
<!-- VERSION 3 -->
## v3 - 2026-09-12 21:05:40 - record the evidence budget frontier, and the slot count it decided



**Status: layers 1 and 3 are built and measured, and the budget sweep after them won; ADR-0014 records it. Layers 2, 4 and 5 are not started.** - an ADR is
written when a layer wins its A/B (section 6). This file exists so the next session starts from the
conclusion instead of re-reading the discussion.
...
<!-- VERSION 4 -->
## v4 - 2026-09-12 21:18:58 - record the dense A/B, the fusion weight it decided, and one retracted claim




**Status: layers 1, 3 and the dense half of 2 are measured; ADR-0014 and ADR-0015 record the two decisions that won. Layers 4 and 5 are not started.** - an ADR is
written when a layer wins its A/B (section 6). This file exists so the next session starts from the
conclusion instead of re-reading the discussion.
...
<!-- VERSION 5 -->
## v5 - 2026-09-12 21:51:03 - measure the remaining layers: the adaptive half and expansion are rejected, the rerank ships
