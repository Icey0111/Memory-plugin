...
| N20 | A batch refused for its anchor section earns exactly one targeted repair that shows the answer and the errors; the repaired answer is re-checked atomically and the repair's cost is reported apart (ADR-0029) | anchorRepairRequest, updateNarrative |
