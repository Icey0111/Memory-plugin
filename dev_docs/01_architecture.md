...
<!-- VERSION 1 -->
## v1 - 2026-09-12 18:10:47 - one pipeline for continuity and evidence, after the layered stack was retired

**Scope of this document.** The whole system on one page, for a reader who does not know the module
names. Superseded designs and their measurements are in Git and in remove/; the decision that
...
<!-- VERSION 2 -->
## v2 - 2026-09-12 18:37:24 - record the measured archive cost and the fact set that left the chat file
