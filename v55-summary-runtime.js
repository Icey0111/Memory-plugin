...
// registering the key with an empty value still costs a projection range the host does not have. See the
// note in v55-consistency.js. This stays as a no-op so the callers and the settings panel keep working.
export function refreshSummaryPrompt(){return false;}
