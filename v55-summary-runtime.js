...
root.querySelector('#aum-v55-summary-enabled').checked=!!s.hierarchical_summary_enabled;root.querySelector('#aum-v55-summary-fold').checked=s.summary_fold_hidden_floors===true;root.querySelector('#aum-v55-summary-auto-rebuild').checked=s.summary_auto_rebuild_on_history_change!==false;for(const[id,key]of[['aum-v55-summary-l1','summary_level1_every_turns'],['aum-v55-summary-l2','summary_level2_every_l1'],['aum-v55-summary-l3','summary_level3_every_l2'],['aum-v55-summary-max-chars','summary_max_context_chars'],['aum-v55-summary-source-chars','summary_source_max_chars'],['aum-v55-summary-fold-keep','summary_fold_keep_recent_floors'],['aum-v55-summary-tokens','summary_max_tokens']])root.querySelector(`#${id}`).value=s[key];root.querySelector('#aum-v55-summary-depth').value=normalizeSummaryInjectionDepth(s.summary_injection_depth,4);render(ctx);return true;}
